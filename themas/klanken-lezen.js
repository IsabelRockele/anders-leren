...
(() => {
  const specs = [
    ...
    ['ui-muis','ui','tweeteken','ui','midden','muis','dieren/muis.png'],['ui-ui','ui','tweeteken','ui','begin','ui','eten/ui.png'],
    ['ie-fiets','ie','tweeteken','ie','midden','fiets','klanken/fiets.png'],['ie-koffie','ie','tweeteken','ie','eind','koffie','eten/koffie.png'],
    ['ei-geit','ei','tweeteken','ei','midden','geit','dieren/geit.png'],['ei-ijs','ei','tweeteken','ij','begin','ijs','eten/ijs.png'],
  ...
  window.THEMA_KLANKEN_LEZEN={
    id:'klanken-lezen',type:'woorden',naam:'Klanken & lezen',emoji:'🔤',kleur:'#7B4BC4',niveaus:['basis'],categorieen:[...new Set(items.map(it=>it.categorie))],
